                            ...
                            <table class="table table-bordered table-hover "  style=" border: 3px solid #757065; background-color:  #cecece ;
                                ...
                                <thead class="" style="background-color: #0084ca; font-size: 18px; color: white;">
                                    <tr>
                                        ...
                                        <td style="font-size: 15px">jornada <br> Modificar</td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: ">
                                            <br>
                                            {{HTML::link("coordinador/horariomodificar/$h->idhorario/$h->idusuario","",["class"=>"glyphicon glyphicon-edit"])}}
                                        </td>
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="header">
                ...
                <p class="category">Escoja el terpaeuta para modificar el horario</p>
            </div>
