    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Modificar horarios </h1>
                    </div>
                    /.col-lg-12 
                </div>
                <div class="row">
                    <div class="col-lg-10">
                        ...
                        <fieldset>
                            ...
                            <div  class="form-group" margin-top="100px">
                                <label class="col-md-4 control-label" for="Estrato">Nombre</label>  
                                <div class="col-md-4">
                                    {{Form::text('Estrato',$terapeuta->nombre_1,[
                    'class'=>"form-control input-md",
                            ...
                            <div  class="form-group" margin-top="100px">
                                <label class="col-md-4 control-label" for="Eps">Apellido</label>  
                                <div class="col-md-4">
                                    {{Form::text('Eps',$terapeuta->apellido_1,[
                    'class'=>"form-control input-md",
                            'readonly'=>"readonly" 
                   ])}}
                                </div> 
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="fecha_inicio">hora de trabajo inicio</label>  
                                <div class="col-md-4">
                                    {{Form::text('hora_inicio',
                  $horario->hora_de_trabajo_inicio, 
                  [' placeholder'=>"DD-MM-YYYY",
                    'class'=>"form-control input-md , hora_inicio"
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="fecha_fin">hora de trabajo fin</label>  
                                <div class="col-md-4">
                                    {{Form::text('hora_fin',
                  $horario->hora_de_trabajo_fin,
                  [' placeholder'=>"DD-MM-YYYY",
                    'class'=>"form-control input-md , hora_fin"
                                ...
                                <div class="form-group">
                                    <strong class="danger" align="center"> {{Session::get('error') }} </strong> 
                                    <div class="col-md-4">
...
<div class="row">
    ...
    <div class="col-lg-12">
        <h2 class="page-header">Modificar horarios </h2>
    </div>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    {{Form::select('hora_inicio', [$horario->hora_de_trabajo_inicio=>$horario->hora_de_trabajo_inicio,'07:00:00' =>'07:00:00','09:00:00'=>'09:00:00','11:00:00'=>'11:00:00'], null, ['class' => 'form-control border-input'])}}
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    {{Form::select('hora_fin', [$horario->hora_de_trabajo_fin=>$horario->hora_de_trabajo_fin,'15:00:00' =>'15:00:00','17:00:00'=>'17:00:00','19:00:00'=>'19:00:00'], null, ['class' => 'form-control border-input'])}}
