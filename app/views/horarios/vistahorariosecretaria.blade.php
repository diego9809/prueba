...
<html lang="en">
    ...
    <head>
        ...
        <title>secretaria consultar agenda</title>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: " >
                                         ...
                                         <td style="background-color: ">
                                            <br>
                                            {{HTML::link("secretaria/verhorario/$h->fisioterapeuta_usuario_idusuario","",["class"=>" glyphicon  glyphicon-eye-open"])}}
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    ...
                    <p class="category">Seleccione el terapeuta para ver el horario</p>
                </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="background-color: ">
                                    <br>
                                    {{HTML::link("secretaria/verhorario/$h->fisioterapeuta_usuario_idusuario","",["class"=>"ti-eye"])}}
