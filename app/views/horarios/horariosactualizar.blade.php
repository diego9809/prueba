                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: ">
                                            <br>
                                            {{HTML::link("terapeuta/modificarhorarios/$h->idhorariopersonal","seleccionar")}}
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h4 class="title">Horarios Terapeuta</h4>
                <p class="category">escoja la franja de horario para modificar  </p>
            </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="background-color: ">
                                <br>
                                {{HTML::link("terapeuta/modificarhorarios/$h->idhorariopersonal","Modificar")}}
