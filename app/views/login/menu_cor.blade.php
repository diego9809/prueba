<html lang="en">
    <head>
        ...
        <title>Kinapsis coordinador</title>
        ...
        {{HTML::style('styles/style/botoncerrar.css')}}
            ...
            <div class="sidebar" data-background-color="white" data-active-color="danger">
                ...
                <div class="sidebar-wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="ti-user"></i> Usuarios <span class="glyphicon glyphicon-chevron-down" style="float:right;"></span></a>
