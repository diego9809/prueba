            ...
            <div class="sidebar" data-background-color="white" data-active-color="danger">
                ...
                <div class="sidebar-wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="ti-wallet "></i> Citas <span class="glyphicon glyphicon-chevron-down" style="float:right;"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    {{HTML::link('cita/cita', 'Registrar')}}
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="ti-user"></i> Paciente <span class="glyphicon glyphicon-chevron-down" style="float:right;"></span></a>
                            <ul class="nav nav-second-level">

                                <li>
                                    {{HTML::link('paciente/registro', 'Registrar')}}
                                </li>
                            </ul>

                        </li>
                        <li>
                            <a href="#"><i class="ti-agenda"></i> Agenda <span class="glyphicon glyphicon-chevron-down" style="float:right;"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    {{HTML::link('secretaria/vistahoraria', 'Consultar')}}
                                </li>
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    {{HTML::link('paciente/consolitu', 'Consultar')}}
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
