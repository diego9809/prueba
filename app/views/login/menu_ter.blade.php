                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                    <li>
                                          {{HTML::link('terapeuta/cancita', 'Cancelar')}}
                                    </li>
                                    <li>
                                          {{HTML::link('terapeuta/concita', 'Ver')}}
                                    </li>
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                     <li>
                                         {{HTML::link('terapeuta/horarios', 'Crear')}}
                                    </li>
                                    <li>
                                    {{HTML::link('terapeuta/modificarhorario', 'Modificar')}}
                                    </li>
                                    <li>
                                    {{HTML::link('terapeuta/horariosvista', 'Consultar')}}
                                    </li>
                            </ul>
