                ...
                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: #f8f8ff">
                                            <br>
                                              ...
                                              {{HTML::link("cita/registrarcitasol/$idorden/$h->idhorariopersonal/$idterapeuta/$idsol/$idpa","",["class"=>" glyphicon  glyphicon-edit"])}}
                                        </td>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-4" align="center">
                               {{HTML::link('cita/verhorariocitasol/$idterapeuta/$idorden/$idpa/$idsol', 'Atras',["class"=>"btn btn-danger","align"=>"center"])}}
...
<div class="card">
            <div class="header">
                ...
                <p class="category">selecione la franja de la cita </p>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4" align="center">
                <br>
                <br>
                {{HTML::link("cita/selecterapeutasol/$idorden/$idpa/$idsol", 'Atras',["class"=>"btn btn-danger","align"=>"center"])}}
