...
<table class="table table-hover tbody tr-hover "  style=" border: 3px solid orange; background-color: #afeefb ;
            ...
            <td>orden llena</td>
            @else
            <td>{{HTML::link("cita/selecterapeutasol/$p->idorden/$id/$idorden","selecionar")}}</td>
            @endif
            </tr>
            ...
            {{$pacientes->links()}}
                           ...
                           {{HTML::link("cita/solcita/$id/$idorden", 'Atras',["class"=>"btn btn-danger"])}}
                            </div>
                            <div class="col-md-2">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                ...
                <p class="category">selecione la orden para registrar la cita</p>
            </div>
