         ...
         {{ Form::open(['class'=>'form-horizontal'])}}
                  ...
                  [' placeholder'=>"DD-MM-YYYY",
                    'class'=>"form-control input-md , fecha"
                                        ...
                                        <br>
                                         @foreach($fecha as $f)
                                    <span class="help-block">el paciente solicita una cita para la fecha {{$f->fecha_cita}} </span>
                                         @endforeach
                    ...
                    'class'=>"form-control input-md"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4" align="center">
                                        ...
                                        {{HTML::link('cita/verhorariocitasol/16/2/13/3', 'Atras',["class"=>"btn btn-danger"])}}
