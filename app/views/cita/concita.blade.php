                ...
                <div class="row">
                    <div class="col-lg-10">
                        ...
                        <table class="table table-hover tbody tr-hover "  style=" border: 3px solid orange; background-color: #afeefb ;
                            ...
                            <thead class="" style="background-color: #ec971f; font-size: 18px; color: white;">
                                <tr>
                                    ...
                                    <td style="font-size: 15px">actualizar</td>
                        ...
                        <fieldset>
                                            ...
                                            {{ Form::hidden('idcita', $p->idcita) }}
                                        <td> <select id="selectbasic" name="terminos" class="form-control">
                                    ...
                                    <td> <button id="singlebutton" name="singlebutton" type="submit" class="btn btn-primary">Modificar</button></td>
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="header">
                ...
                <p class="category">Escoja la cita para actualizar su estado</p>
            </div>
