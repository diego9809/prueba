...
{{Form::close()}}
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: " >
                                         ...
                                         <td style="background-color: ">
                                            ...
                                            {{HTML::link("cita/verhorariocita/$h->fisioterapeuta_usuario_idusuario/$idorden","",["class"=>" glyphicon  glyphicon-eye-open"])}}
                            ...
                            <div class="col-md-4" align="center">
                                 {{HTML::link("cita/cita", 'Atras',["class"=>"btn btn-danger","align"=>"center"])}}
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="header">
                <h4 class="title"> Lista de terapeutas</h4>
                <p class="category">escoja el terapeuta para la cita</p>
            </div>
            <div class="content table-responsive table-full-width">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="background-color: ">
                                ...
                                {{HTML::link("cita/verhorariocita/$h->fisioterapeuta_usuario_idusuario/$idorden","",["class"=>" ti-eye"])}}
                ...
                <br>
                                 ...
                                 {{HTML::link("cita/cita", 'Atras',["class"=>"btn btn-primary","align"=>"center"])}}
