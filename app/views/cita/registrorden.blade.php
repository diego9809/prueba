    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Registrar orden</h1>
                    </div>
                     /.col-lg-12 
                </div>
                <div class="row">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="termino">Ingrese nombre del paciente</label>  
  <div class="col-md-4">
      
  <input id="textinput" name="termino" placeholder="Cliente" class="form-control input-md" type="text">
  ...
  <div class="col-md-4">
      <button id="singlebutton" name="singlebutton" type="submit" class="btn btn-primary">Buscar</button>
        ...
        <table class="table table-hover tbody tr-hover "  style=" border: 3px solid orange; background-color: #afeefb ;
            ...
            <td>{{HTML::link("cita/registrarorden/$p->usuario_idusuario","selecionar")}}</td>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                ...
                <p class="category">escoja el paciente para registrar la orden</p>
            </div>
