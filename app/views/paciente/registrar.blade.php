...
<html lang="en">
    ...
    <head>
        ...
        <title>secretaria registrar paciente</title>
...
<div class="row">
    ...
    <div class="col-lg-12">
        <h2 class="page-header">Registrar paciente</h2>
    </div>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    {{Form::select('tipo_documento', [1 =>'Tarjeta de identidad',2 =>'Cédula de ciudadania',3 =>'Registro civil'], null, ['class' => 'form-control border-input'])}}
