                    ...
                    <div class="col-lg-10">
                        ...
                        <table class="table table-hover tbody tr-hover "  style=" border: 3px solid orange; background-color: #afeefb ;
                            ...
                            <thead class="" style="background-color: #ec971f; font-size: 18px; color: white;">
                                <tr>
                                    ...
                                    <td style="font-size: 15px">Modificar Paciente</td>
                            ...
                            <tbody >
                                ...
                                <tr>
                                    ...
                                    <td>{{$p->telefono}}</td>
                                    <td>{{$p->aseguradora}}</td>
                                    <td>{{HTML::link("paciente/actualizar/$p->usuario_idusuario","",["class"=>"glyphicon glyphicon-edit"])}}</td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4" align="center">
                                {{HTML::link('paciente/index', 'Atras',["class"=>"btn btn-danger","align"=>"center"])}}
